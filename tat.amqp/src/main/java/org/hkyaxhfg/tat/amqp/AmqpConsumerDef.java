 ...
 * @date: 2022/1/19
 */
@ConfigurationProperties(prefix = AutoConfigurationProperty.AMQP_CONSUMER_MAIN_KEY)
public class AmqpConsumerDef {
    /**
     * 是否启动Amqp自动配置.
     */
    private boolean enabled = AutoConfigurationProperty.AMQP_CONSUMER.isDefaultValue();
    /**
     * amqp描述.
     */
